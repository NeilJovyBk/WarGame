...
public class preparationcombat3 {
	 ...
	 */
	public static void ouvrePreparation3 () {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					preparationcombat3 window = new preparationcombat3();
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1_2 = new JLabel("1 combattant sur les zones conquis");
	  ...
	  //-------------------------------------------------BOUTON CONTINUER--------------------------------------------------------
		...
		ButtonContinuer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					animationcombat3.ouvreAnimation3();
		...
		String encombat[] = {"Soldat_2", "Soldat_4", "Soldat_6", "Soldat_7", "Soldat_9", "Soldat_11", "Soldat_13", "Soldat_15", "Elite_1", "Elite_3", "Elite_4", "MDG"};
		String elimines[] = {"Soldat_1", "Soldat_3", "Soldat_5", "Elite_2", "Soldat_14", "Soldat_8", "Soldat_10", "Soldat_12"};

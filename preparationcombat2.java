...
public class preparationcombat2 {
	 ...
	 */
	public static void ouvrePreparation2() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					preparationcombat2 window = new preparationcombat2();
	...
	private void initialize() {
		...
		frmpreparationcombat.getContentPane().add(drapeau_victoire);
	  ...
	  //-------------------------------------------------BOUTON CONTINUER--------------------------------------------------------
		...
		ButtonContinuer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(VerificationAllNumber(frmpreparationcombat)) {
					animationcombat2.ouvreAnimation2();
		...
		String encombat[] = {"Soldat_4", "Soldat_6", "Soldat_7", "Soldat_8", "Soldat_9", "Soldat_13", "Elite_4"};
		String elimines[] = {"Soldat_1", "Soldat_3", "Soldat_5", "Elite_2", "Soldat_14"};

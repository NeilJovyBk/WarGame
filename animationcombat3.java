...
public class animationcombat3 {
	 ...
	 */
    public static void ouvreAnimation3 () {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					animationcombat3 window = new animationcombat3();
	...
	private void initialize() {
		...
		int[] PVzone4 = {75, 85, 87, 90, 95, 100};
  	...
  	//------------------------------------------------CREATION DU CHAT--------------------------------------------------------
		...
		ButtonContinuer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				preparationcombat4.ouvrePreparation4();
		...
		JLabel LabelVictoire2 = new JLabel("la Bibliothèque !");

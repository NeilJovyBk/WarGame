...
public class preparationcombat {
	 ...
	 */
	public static void ouvrePreparation () {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					preparationcombat window = new preparationcombat();
				...
				for (Component componentJP1 : componentsJP1) {
					if(componentJP1 instanceof JPanel && componentJP1.getBackground().equals(Color.BLUE)) {
						...
						for (Component componentJP2 : componentsJP2) {
							...
							else if (componentJP2 instanceof JLabel && ((JLabel) componentJP2).getText().equals("2")) {
								var2 = true;
							}
							else if (componentJP2 instanceof JLabel && ((JLabel) componentJP2).getText().equals("3")) {
								var3 = true;
							}
							else if (componentJP2 instanceof JLabel && ((JLabel) componentJP2).getText().equals("4")) {
								var4 = true;
							}
							else if (componentJP2 instanceof JLabel && ((JLabel) componentJP2).getText().equals("5")) {
								var5 = true;
							}
						}
					}
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1_2 = new JLabel("1 combattant sur chaque zone ");
	  ...
	  //-------------------------------------------------BOUTON CONTINUER--------------------------------------------------------
		...
		ButtonContinuer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(VerificationAllNumber(frmpreparationcombat)) {
					animationcombat.ouvreAnimation1();
		...
		for(int j = 1; j < 6; j++) {
			JLabel zone = new JLabel("" + j);
			zone.setBounds(50, 0, 15, 20);
			zone.setForeground(Color.WHITE);
			zone.setFont(customFont.deriveFont(13f));
			zone.setHorizontalAlignment(SwingConstants.CENTER);
			zone.setVisible(false);
			ButtonSoldat.add(zone);
		}
		...
		String reservistes[] = {"Soldat_2", "Soldat_12", "Elite_1", "Elite_3", "MDG"};
		
		for (String reserviste : reservistes) {
			JButton button = getButton(frmpreparationcombat, reserviste);

...
public class animationcombat {
	 ...
	 */
    public static void ouvreAnimation1 () {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					animationcombat window = new animationcombat();
	...
	private void initialize() {
  	...
  	//------------------------------------------------CREATION DU CHAT--------------------------------------------------------
		...
		ButtonContinuer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				preparationcombat2.ouvrePreparation2();
		...
		JLabel LabelVictoire2 = new JLabel("la Halle sportive !");
	...
	//-----------------------------------------------------ALTERNANCE D'IMAGE---------------------------------------------------
		...
		JLabel eclatzone1_50 = repartitionpoint.createLabelImage("C:\\Users\\Neil Jovy\\eclipse-workspace\\EG23\\img\\eclat50.png",264, 147, 50, 50); 
		frmAnimationDuCombat.getContentPane().add(eclatzone1_50);
		JLabel eclatzone1_25 = repartitionpoint.createLabelImage("C:\\Users\\Neil Jovy\\eclipse-workspace\\EG23\\img\\eclat25.png",276, 160, 25, 25); 
		eclatzone1_25.setVisible(false);
		frmAnimationDuCombat.getContentPane().add(eclatzone1_25);
		...
		timer = new Timer(500, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (showFirstImage) {
                	...
                	//zone1
                	eclatzone1_25.setVisible(true);
                	eclatzone1_50.setVisible(false);
                	//zone2
	...
	//------------------------------------------------------SCHEMA DE L'UTT----------------------------------------------------
		...
		slider1.setForeground(new Color(255, 255, 255));
		slider1.setBackground(new Color(0, 0, 0));
		slider1.setBounds(154, 120, 161, 25);
		frmAnimationDuCombat.getContentPane().add(slider1);
		
		JLabel icon_victoire1 = new JLabel("");
		icon_victoire1.setIcon(new ImageIcon("C:\\Users\\Neil Jovy\\eclipse-workspace\\EG23\\img\\icon_victoire.PNG"));
		icon_victoire1.setBounds(325, 120, 25, 25);
		frmAnimationDuCombat.getContentPane().add(icon_victoire1);
		
		JLabel icon_defaite1 = new JLabel("");
		icon_defaite1.setIcon(new ImageIcon("C:\\Users\\Neil Jovy\\eclipse-workspace\\EG23\\img\\icon_defaite.PNG"));
		icon_defaite1.setBounds(120, 120, 25, 25);
		frmAnimationDuCombat.getContentPane().add(icon_defaite1);
